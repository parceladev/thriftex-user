  ...
  resources: {
    en: {
      translation: {
        ...
        "Enter your email and we’ll send you a link to get back into your account": "Enter your email and we’ll send you a link to get back into your account",
        "Send Reset Link": "Send Reset Link",
        "Sending...": "Sending...",
        "Login with different account": "Login with different account",
        "Email Sent": "Email Sent",
        "We sent an email to {{email}} with a link to reset the password.": "We sent an email to {{email}} with a link to reset the password.",
        "Error": "Error",
        ...
        "Have any account?": "Already have an account?",
        ...
        "Registration Success! Redirecting to sign in...": "Registration Success! Redirecting to sign in...",
        "Login with Google failed. Please try again.": "Login with Google failed. Please try again.",
    ...
    id: {
      translation: {
        ...
        Loading: "Memuat...",
         ...
         // Forget Password Form
         "Trouble logging in?": "Kesulitan masuk?",
         "Enter your email and we’ll send you a link to get back into your account": "Masukkan email Anda dan kami akan mengirimkan tautan untuk masuk kembali ke akun Anda",
         "Send Reset Link": "Kirim Tautan Reset",
         "Sending...": "Mengirim...",
         "Login with different account": "Masuk dengan akun berbeda",
         "Email Sent": "Email Terkirim",
         "We sent an email to {{email}} with a link to reset the password.": "Kami telah mengirim email ke {{email}} dengan tautan untuk mengatur ulang kata sandi.",
         "Error": "Kesalahan",
         "An unexpected error occurred": "Terjadi kesalahan yang tidak terduga",

        //Sign in/up Page
        "Have any account?": "Sudah punya akun?",
        "Don't have any account?": "Tidak Mempunyai akun?",
        "Redirecting": 'Harap Tunggu, Mengarahkan...',
        "All fields must be filled.": "Semua kolom harus diisi.",
        "Please enter a valid email address.": "Silakan masukkan alamat email yang valid.",
        "Password must be at least 8 characters long.": "Kata sandi harus terdiri dari minimal 8 karakter.",
        "Password does not match!": "Kata sandi tidak cocok!",
        "Your Name": "Nama Anda",
        "Your Email": "Email Anda",
        "Your Password": "Kata Sandi Anda",
        "Username or Email": "Nama dan Email",
        "Confirm Password": "Konfirmasi Kata Sandi",
        "Registration Success! Redirecting to sign in...": "Registrasi Berhasil! Mengarahkan ke halaman masuk...",
        "Login with Google failed. Please try again.": "Login dengan Google gagal. Silakan coba lagi.",
