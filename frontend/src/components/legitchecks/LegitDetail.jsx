      ...
      <div className="w-full max-w-5xl mx-auto overflow-hidden bg-white rounded-lg shadow-lg">
        ...
        <div className="p-4 overflow-y-auto" style={{ maxHeight: '80vh' }}>
          ...
          <div className="flex items-center justify-center w-full gap-5 pt-6">
            <span className="h-[1px] w-1/2 sm:w-1/12 bg-gray-800"></span>
            <h3 className="text-lg font-semibold text-center uppercase w-[450px] sm:w-56">
              Legit Check Result
            </h3>
            <span className="h-[1px] w-1/2 sm:w-10/12 bg-gray-800"></span>
          </div>
          {hasAuthenticityData ? (
            ...
            <div className="flex gap-3 py-3 text-gray-700">
              <svg
                width="20"
                height="21"
                viewBox="0 0 20 21"
