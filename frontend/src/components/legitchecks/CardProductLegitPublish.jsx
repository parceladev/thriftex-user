  ...
  return (
    <div>
      <div
        ...
        className="flex flex-col border border-black rounded-md shadow-md cursor-pointer dark:bg-secondary dark:border-gray-600 hover:bg-gray-200 shadow-gray-400 dark:shadow-none"
      >
        <img
          className="rounded-md h-44 sm:h-80"
